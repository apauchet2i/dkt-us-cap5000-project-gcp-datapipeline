...
public class OrderStatus {
    ...
    public static void setParametersOrderStatusSQL(TableRow element, PreparedStatement preparedStatement) throws Exception {
        preparedStatement.setString(1, element.get("order_number").toString());
        preparedStatement.setString(2, element.get("source").toString());
        preparedStatement.setString(3, element.get("type").toString());
